...
//originally the below routes said (app.get('/twitterlogin/callback') and then later (app.get('/twitter')) but this stackoverflow helped me realize that twitter automatically wants the call back URL to be /auth/twitter' and '/auth/twitter/callback' even though it is an auth file already)
